...
def get_wire_metadata(wire_names: List[str] = []):
    ...
    wire_metadata = {
        ...
        "WSC104": {"lblms": col1_lblms},
        "WSC106": {"lblms": col1_lblms},
        "WSC108": {"lblms": col1_lblms},
        "WSC110": {"lblms": col1_lblms},
        "WSEMIT2": {"lblms": emit2_lblms},
        "WSBP1": {"lblms": byp_lblms},
        "WSBP2": {"lblms": byp_lblms},
        "WSBP3": {"lblms": byp_lblms},
        "WSBP4": {"lblms": byp_lblms},
        "WSSP1D": {"lblms": spd_lblms},
        "WS31B": {"lblms": ltus_lblms},
        "WS32B": {"lblms": ltus_lblms},
        "WS33B": {"lblms": ltus_lblms},
        "WS34B": {"lblms": ltus_lblms},
    }
