...
def compute_emit_bmag(k: ndarray, 
    ...
    beam_matrix, total_rmat = reconstruct_beam_matrix(k, beamsize_squared, q_len, rmat, thin_lens=thin_lens, maxiter=maxiter)
    emit = np.sqrt(beam_matrix[...,0,0]*beam_matrix[...,2,0] - beam_matrix[...,1,0]**2) # result shape (batchshape)
